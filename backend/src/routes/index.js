...
const portfolioManagerRoutes = require("./portfoliomanager.routes");
...
router.use("/chat-management", require("./chat_management.routes"));
...
router.use("/portfolio-managers", portfolioManagerRoutes);
