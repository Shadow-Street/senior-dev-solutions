...
db.User.hasMany(db.ChatRoomParticipant, { foreignKey: 'user_id' });
db.ChatRoomParticipant.belongsTo(db.User, { foreignKey: 'user_id' });
...
db.Message.hasMany(db.MessageReadReceipt, { foreignKey: 'message_id' });
db.MessageReadReceipt.belongsTo(db.Message, { foreignKey: 'message_id' });
...
db.Invoice.belongsTo(db.Subscription, { foreignKey: 'subscription_id' });
db.Invoice.belongsTo(db.User, { foreignKey: 'user_id' });
db.Subscription.hasMany(db.Invoice, { foreignKey: 'subscription_id' });
