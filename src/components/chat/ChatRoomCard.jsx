...
import { Users, Calendar, BarChart, Circle, MoreVertical, Trash2, Crown, Shield, MessageSquare, Lock } from "lucide-react";
...
export default function ChatRoomCard({ room, onDelete, user, onRoomClick, isLocked = false }) {
  ...
  return (
    <Card
      className={`${getCardGradient()} border-0 shadow-lg hover:shadow-2xl transition-all duration-300 cursor-pointer transform hover:scale-105 ${
        isLocked ? 'opacity-75 cursor-not-allowed' : ''
      }`}
      onClick={() => !isLocked && onRoomClick(room)}
    >
