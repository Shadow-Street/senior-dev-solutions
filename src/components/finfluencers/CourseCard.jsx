  ...
  return (
    <>
      ...
      <Card className={`group shadow-xl border-0 bg-white flex flex-col overflow-hidden hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 ${
        isLocked ? 'opacity-90 border-2 border-purple-200' : ''
      }`}>
        {/* Course Type Header with Gradient - Modified to include h-48 and overflow-hidden, and the lock overlay */}
        <div className="relative bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 p-6 text-white h-48 overflow-hidden">
          ...
          {isLocked && (
            <div className="absolute inset-0 bg-gradient-to-t from-purple-900/90 via-purple-600/70 to-transparent flex items-center justify-center">
          ...
          <div className="flex items-center justify-between mt-auto pt-4 border-t border-slate-100">
            ...
            {isLocked ? (
              ...
              <Button 
                ...
                className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white hover:shadow-xl hover:scale-105 transition-all duration-300 px-6 py-2.5 font-semibold" // Updated styling as per outline
              >
                Enroll Now
              </Button>
            )}
