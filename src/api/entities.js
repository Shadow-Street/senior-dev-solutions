...
export const ChatRoomParticipant = base44.entities.ChatRoomParticipant;

export const ChatRoomSchedule = base44.entities.ChatRoomSchedule;

export const ModerationRule = base44.entities.ModerationRule;

export const ChatRoomInvite = base44.entities.ChatRoomInvite;

export const ChatRoomTemplate = base44.entities.ChatRoomTemplate;

export const RoomSubscription = base44.entities.RoomSubscription;

export const VIPCustomization = base44.entities.VIPCustomization;

export const Announcement = base44.entities.Announcement;

export const AdvisorComplaint = base44.entities.AdvisorComplaint;

export const EventPromoCode = base44.entities.EventPromoCode;

export const EventCheckIn = base44.entities.EventCheckIn;

export const EventReminder = base44.entities.EventReminder;

export const EventFeedback = base44.entities.EventFeedback;

export const AdvisorPledgeAccessRequest = base44.entities.AdvisorPledgeAccessRequest;

export const AdvisorPledgeCommission = base44.entities.AdvisorPledgeCommission;

export const PortfolioManager = base44.entities.PortfolioManager;

export const PMClient = base44.entities.PMClient;

export const PMStrategy = base44.entities.PMStrategy;

export const PMHolding = base44.entities.PMHolding;

export const PMTradeOrder = base44.entities.PMTradeOrder;

export const PMNAVSnapshot = base44.entities.PMNAVSnapshot;

export const PMInvoice = base44.entities.PMInvoice;
